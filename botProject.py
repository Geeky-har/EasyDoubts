...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:123@localhost/EasyDoubt'

english_bot = ChatBot('Chatterbot', storage_adapter='chatterbot.storage.SQLStorageAdapter',
                      database_uri='postgresql://postgres:123@localhost/EasyDoubt')
...
# config for video thumbnail in the home page
...
# config for suggestions that has to be shown in the chatbot
